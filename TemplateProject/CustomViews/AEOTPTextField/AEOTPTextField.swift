...
public class AEOTPTextField: UITextField {
    ...
    public var otpBackgroundColor: UIColor { ColorManager.ColorCase.textFieldBackground.color }
    
    
    /// The default background color of the text field slots after entering a character
    public var otpFilledBackgroundColor: UIColor { ColorManager.ColorCase.textFieldBackground.color }
    ...
    public var otpDefaultBorderColor: UIColor { ColorManager.ColorCase.AEOTPTextFieldBackground.color }
    
    /// The border color of the text field slots after entering a character
    public var otpFilledBorderColor: UIColor { ColorManager.ColorCase.textFieldBorder.color }
    ...
    public var otpTextColor: UIColor { ColorManager.ColorCase.textFieldText.color }
    
    /// The default font size of the text
    public var otpFontSize: CGFloat = 18
    
    /// The default font of the text
    public var otpFont: UIFont = UIFont.systemFont(ofSize: 18)
    ...
    public func updateAppearance() {
        ...
        digitLabels.forEach { currentLabel in
            ...
            currentLabel.layer.borderColor  = otpDefaultBorderColor.cgColor
            currentLabel.backgroundColor    = otpBackgroundColor
            currentLabel.layer.cornerRadius = otpCornerRaduis
            currentLabel.translatesAutoresizingMaskIntoConstraints = false
            currentLabel.textAlignment = .center
            currentLabel.textColor = otpTextColor
            currentLabel.font = currentLabel.font.withSize(otpFontSize)
            currentLabel.font = otpFont
            currentLabel.isUserInteractionEnabled = true
            currentLabel.layer.masksToBounds = true
            currentLabel.layoutIfNeeded()
        }
    }
